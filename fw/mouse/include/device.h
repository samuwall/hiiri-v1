...
typedef struct {
    IO32 TASKS_START;
    IO32 TASKS_STOP;
    IO32 TASKS_READCLRACC;
    IO32 TASKS_RDCLRACC;
    IO32 TASKS_RDCLRDBL;
    IO32 RESERVED[59];
    IO32 EVENTS_SAMPLERDY;
    IO32 EVENTS_REPORTRDY;
    IO32 EVENTS_ACCOF;
    IO32 EVENTS_DBLRDY;
    IO32 EVENTS_STOPPED;
    IO32 RESERVED1[59];
...
#define SPIM_ENABLE_ENABLE_Shft         0U
#define SPIM_PSEL_PIN_Shft              0U
#define SPIM_PSEL_CONNECT_Shft          31U
#define SPIM_CONFIG_ORDER_Shft          0U
#define SPIM_CONFIG_CPHA_Shft           1U
#define SPIM_CONFIG_CPOL_Shft           2U

#define GPIOTE_CONFIG_MODE_Shft         0U
#define GPIOTE_CONFIG_PSEL_Shft         8U
#define GPIOTE_CONFIG_POLARITY_Shft     16U
#define GPIOTE_CONFIG_OUTINIT_Shft      20U

#define QDEC_SAMPLEPER_SAMPLEPER_Shft   0U
#define QDEC_PSEL_PIN_Shft              0U
#define QDEC_PSEL_CONNECT_Shft          31U

#define COMP_PSEL_PSEL_Shft             0U
#define COMP_REFSEL_REFSEL_Shft         0U
#define COMP_TH_THDOWN_Shft             0U
#define COMP_TH_THUP_Shft               8U
#define COMP_MODE_SP_Shft               0U
...
#define RADIO_SHORTS_TXREADY_START_                         (1 << 18)
#define RADIO_SHORTS_RXREADY_START_                         (1 << 19)

#define RADIO_INTENSET_DISABLED_Set                         (1 << 4)
#define RADIO_INTENSET_TXREADY_Set                          (1 << 21)
...
#define SPIM_ENABLE_ENABLE_Disabled                         (0b0000 << SPIM_ENABLE_ENABLE_Shft)
#define SPIM_ENABLE_ENABLE_Enabled                          (0b0111 << SPIM_ENABLE_ENABLE_Shft)

#define SPIM_PSEL_CONNECT_Disconnected                      (1 << SPIM_PSEL_CONNECT_Shft)
#define SPIM_PSEL_CONNECT_Connected                         (0 << SPIM_PSEL_CONNECT_Shft)

#define SPIM_FREQUENCY_FREQUENCY_125Kbps                    (0x02000000)
#define SPIM_FREQUENCY_FREQUENCY_1Mbps                      (0x10000000)
#define SPIM_FREQUENCY_FREQUENCY_4Mbps                      (0x40000000)

#define SPIM_CONFIG_ORDER_MsbFirst                          (0 << SPIM_CONFIG_ORDER_Shft)
#define SPIM_CONFIG_ORDER_LsbFirst                          (1 << SPIM_CONFIG_ORDER_Shft)
#define SPIM_CONFIG_CPHA_Leading                            (0 << SPIM_CONFIG_CPHA_Shft)
#define SPIM_CONFIG_CPHA_Trailing                           (1 << SPIM_CONFIG_CPHA_Shft)
#define SPIM_CONFIG_CPOL_ActiveHigh                         (0 << SPIM_CONFIG_CPOL_Shft)
#define SPIM_CONFIG_CPOL_ActiveLow                          (1 << SPIM_CONFIG_CPOL_Shft)

/* --- GPIOTE -------------------------------------------------------------- */

#define GPIOTE_INTENSET_PORT_Set                            (1 << 31)

#define GPIOTE_CONFIG_MODE_Disabled                         (0b00 << GPIOTE_CONFIG_MODE_Shft)
#define GPIOTE_CONFIG_MODE_Event                            (0b01 << GPIOTE_CONFIG_MODE_Shft)
#define GPIOTE_CONFIG_MODE_Task                             (0b11 << GPIOTE_CONFIG_MODE_Shft)
#define GPIOTE_CONFIG_POLARITY_None                         (0b00 << GPIOTE_CONFIG_POLARITY_Shft)
#define GPIOTE_CONFIG_POLARITY_LoToHi                       (0b01 << GPIOTE_CONFIG_POLARITY_Shft)
#define GPIOTE_CONFIG_POLARITY_HiToLo                       (0b10 << GPIOTE_CONFIG_POLARITY_Shft)
#define GPIOTE_CONFIG_POLARITY_Toggle                       (0b11 << GPIOTE_CONFIG_POLARITY_Shft)
#define GPIOTE_CONFIG_OUTINIT_Low                           (0 << GPIOTE_CONFIG_OUTINIT_Shft)
#define GPIOTE_CONFIG_OUTINIT_High                          (1 << GPIOTE_CONFIG_OUTINIT_Shft)
...
#define QDEC_ENABLE_ENABLE_Enabled                          (1 << 0)
#define QDEC_ENABLE_ENABLE_Disabled                         (0 << 0)

#define QDEC_SAMPLEPER_SAMPLEPER_128us                      (0b0000 << QDEC_SAMPLEPER_SAMPLEPER_Shft)

#define QDEC_PSEL_CONNECT_Disconnected                      (1 << QDEC_PSEL_CONNECT_Shft)
#define QDEC_PSEL_CONNECT_Connected                         (0 << QDEC_PSEL_CONNECT_Shft)

#define QDEC_DBFEN_DBFEN_Enabled                            (1 << 0)
#define QDEC_DBFEN_DBFEN_Disabled                           (0 << 0)

/* --- COMP ---------------------------------------------------------------- */

#define COMP_SHORTS_READY_SAMPLE_Enabled                    (1 << 0)
#define COMP_SHORTS_READY_STOP_Enabled                      (1 << 1)

#define COMP_INTENSET_READY_Set                             (1 << 0)

#define COMP_ENABLE_ENABLE_Disabled                         (0b00 << 0)
#define COMP_ENABLE_ENABLE_Enabled                          (0b10 << 0)

#define COMP_PSEL_PSEL_VddhDiv5                             (0b111 << COMP_PSEL_PSEL_Shft)

#define COMP_REFSEL_REFSEL_Int1v2                           (0b000 << COMP_REFSEL_REFSEL_Shft)

#define COMP_MODE_SP_Low                                    (0b00 << COMP_MODE_SP_Shft)
#define COMP_MODE_SP_Normal                                 (0b01 << COMP_MODE_SP_Shft)
#define COMP_MODE_SP_High                                   (0b10 << COMP_MODE_SP_Shft)
#define COMP_MODE_MAIN_SE                                   (0 << 8)
#define COMP_MODE_MAIN_Diff                                 (1 << 8)
